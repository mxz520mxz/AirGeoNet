...
class AdaptationBlockOutput(nn.Sequential):
    def __init__(self, inp, out):
        conv1 = nn.Conv2d(inp, int(inp/2), kernel_size=1, padding=0, bias=True)
        conv2 = nn.Conv2d(int(inp/2), out, kernel_size=1, padding=0, bias=True)
