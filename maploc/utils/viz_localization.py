...
def likelihood_overlay(
    prob, map_viz=None, p_rgb=0.2, p_alpha=1 / 15, thresh=None, cmap="jet", margin=512
):
    center_x, center_y = prob.shape[0] // 2, prob.shape[1] // 2
    print('prob shape:',prob.shape)
    prob = prob[center_x - margin:center_x + margin, center_y - margin:center_y + margin]
    prob = prob / prob.max()
    print('prob shape:',prob.shape)
